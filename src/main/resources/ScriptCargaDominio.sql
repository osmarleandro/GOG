...
ALTER SEQUENCE tbareaentrada_idareaentrada_seq RESTART WITH 169;
...
ALTER SEQUENCE tbfaixaetaria_idfaixaetaria_seq RESTART WITH 2024;
...
ALTER SEQUENCE tbfuncionalidade_idfuncionalidade_seq RESTART WITH 43;
...
ALTER SEQUENCE tbgrauinstrucao_idgrauinstrucao_seq RESTART WITH 14;
...
ALTER SEQUENCE tbmeioentrada_idmeioentrada_seq RESTART WITH 1061;
...
ALTER SEQUENCE tbpais_idpais_seq RESTART WITH 252;
...
INSERT INTO tbPerfil (idPerfil, tpPerfil, nmPerfil) VALUES (2041, '1', 'Perfil Priscila');
...
ALTER SEQUENCE tbperfil_idperfil_seq RESTART WITH 2046;
...
INSERT INTO tbPerfilxFuncionalidade (idPerfilxFuncionalidade, idPerfil, idFuncionalidade) VALUES (6	2041	31);
...
ALTER SEQUENCE tbperfilxfuncionalidade_idperfilxfuncionalidade_seq RESTART WITH 56;

--tbPreferenciaSistema
INSERT INTO tbPreferenciaSistema (idPreferenciaSistema, nomeOuvidoria, emailOuvidoria, hostEmail, portaEmail, usuarioEmail, senhaEmail, sslEmail, encerrarTramiteEncaminhada, retornarTramiteOuvidoria, ctlPrazoManifSoluc, RespostasImediatas, prazoEntrada, prazoAreaSolucionadora, prazoRespostaCidadao) VALUES (1, 'Ouvidoria MinC', 'naoresponda.ouvidoria@cultura.gov.br', '10.0.0.54', 25, 'ouvidoria@cultura.gov.br', '', '2', '1', '1', '1', '1', 1, 28, 1);
...
ALTER SEQUENCE tbprioridade_idprioridade_seq RESTART WITH 1021;
...
ALTER SEQUENCE tbtipomanifestacao_idtipomanifestacao_seq RESTART WITH 2031;
...
ALTER SEQUENCE tbuf_iduf_seq RESTART WITH 27;
...
ALTER SEQUENCE tbunidade_idunidade_seq RESTART WITH 3042;
...
*/
INSERT INTO tbUsuario (idUsuario, nmUsuario, stStatus, eeEmail, idUnidade, tpUsuario, nmLogin, numTelefone, nmSenha, tpFuncao) VALUES (1, 'root', 1, 'email@email.com', 1, '1', 'root', '(61)99999999', 'A0729799124513324E1BC0FE8AA1F046', '5');
ALTER SEQUENCE tbusuario_idusuario_seq RESTART WITH 1;
...
ALTER SEQUENCE tbmunicipio_idmunicipio_seq RESTART WITH 5565;
